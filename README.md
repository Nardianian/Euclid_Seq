Work in Progress, at this moment not finished, unstable, crash.
...
D) ARP, the MIDI stream thus generated enters the arpeggiator:
   ...
   D3) Using the tickable popup menu with "Note" snapshot, user can view the incoming notes (from the MIDI stream of the rhythm created so far) and can select up to seven notes with their respective octaves (e.g., 
   ...
   D5) Use "Rate" to select the arpeggio speed of the selected notes.
